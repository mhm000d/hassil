  ...
  return (
    <div className="login-page">
      ...
      <div className="login-card">
        ...
        <h1 className="login-card__title">Welcome Back, Company</h1>
        <p className="login-card__subtitle">
          Sign in to your company account to manage financing and cash flows.
        </p>
        ...
        <form className="login-card__form" onSubmit={handleSubmit}>
          ...
          <button type="submit" className="login-card__submit" id="btn-company-login">
            Sign In
