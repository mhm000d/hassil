...
export default function FreelancerOnboarding() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    // No backend — navigate directly to freelancer home
        ...
        <form className="onboarding-form" onSubmit={handleSubmit}>
          ...
          <div className="onboarding-form__row">
            <div className="onboarding-field">
              <label className="onboarding-field__label" htmlFor="ob-fullName">
                FULL NAME
              </label>
              <input
                id="ob-fullName"
            ...
            <div className="onboarding-field">
              ...
              <input
                ...
                type="email"
                className="onboarding-field__input"
                placeholder="mona.ux@example.com"
                value={form.email}
                onChange={handleChange}
                required
              />
