...
export default function SmallBusinessOnboarding() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    // No backend — navigate directly to company home
    ...
    <div className="onboarding-page">
      <div className="onboarding-card">
        ...
        <form className="onboarding-form" onSubmit={handleSubmit}>
          {/* Row 1: Business Name + Reg Num */}
          <div className="onboarding-form__row">
            <div className="onboarding-field">
              <label className="onboarding-field__label" htmlFor="ob-businessName">
                BUSINESS NAME
              </label>
              <input
                id="ob-businessName"
                ...
                placeholder="Cairo Visual Works"
            ...
            <div className="onboarding-field">
              <label className="onboarding-field__label" htmlFor="ob-registrationNumber">
                REGISTRATION NUMBER
              </label>
              <input
          ...
          <div className="onboarding-form__row">
            <div className="onboarding-field">
              <label className="onboarding-field__label" htmlFor="ob-email">
                EMAIL
              </label>
              <input
                id="ob-email"
                ...
                type="email"
                className="onboarding-field__input"
                placeholder="finance@cairovisual.example"
                value={form.email}
                onChange={handleChange}
                required
              />
            ...
            <div className="onboarding-field">
              <label className="onboarding-field__label" htmlFor="ob-phone">
                PHONE NUMBER
              </label>
              <input
                id="ob-phone"
          ...
          {/* Row 3: Country + Bank Name */}
          <div className="onboarding-form__row">
            <div className="onboarding-field">
              <label className="onboarding-field__label" htmlFor="ob-country">
                COUNTRY
              </label>
              <input
                id="ob-country"
            ...
            <div className="onboarding-field">
              <label className="onboarding-field__label" htmlFor="ob-bankName">
              ...
              <input
                ...
                type="text"
                className="onboarding-field__input"
                placeholder="Cairo Visual Works LLC"
                value={form.bankName}
                onChange={handleChange}
                required
              />
          ...
          <div className="onboarding-form__row">
            <div className="onboarding-field" style={{ flex: '0 0 48%' }}>
              <label className="onboarding-field__label" htmlFor="ob-bankLast4">
