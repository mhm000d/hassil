      ...
      <div className="container hero__inner">
        ...
        <div className="hero__content">
          ...
          <div className="hero__buttons">
            <button className="hero__btn-primary" id="btn-get-started">
              Get Started
            </button>
            <button className="hero__btn-secondary" id="btn-how-it-works">
              How it works
            </button>
          </div>
        </div>
        ...
        <div className="hero__stats">
          <div className="hero__stat-card hero__stat-card--light">
            ...
            <div className="hero__stat-label">
              of MENA MSMEs lack access to finance
            </div>
          </div>
