...
const features = [
  {
    ...
    description:
      'We operate on a transparent, flat-fee model. Ethical financing that respects regional financial values and provides predictability.',
    icon: (
  ...
  },
  {
    ...
    description:
      'Built from the ground up for the MENA region. We understand the specific payment cycles and legal frameworks of regional markets.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      'Your data and transactions are protected by bank-grade encryption and regional regulatory compliance standards.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <div className="why-hassil__features">
            {features.map((feature) => (
              <div className="why-hassil__feature" key={feature.title}>
                <div className="why-hassil__feature-icon">
                  {feature.icon}
                </div>
