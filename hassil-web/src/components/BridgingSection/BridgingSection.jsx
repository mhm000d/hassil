      ...
      <div className="container">
        ...
        <div className="bridging__cards">
          ...
          <div className="bridging__card bridging__card--smb">
            <div className="bridging__card-icon">
              <SMBIcon />
            </div>
            ...
            <div className="bridging__card-features">
              <div className="bridging__card-feature">
                <CheckIcon />
                <span>Instant liquidity for confirmed invoices</span>
              </div>
              <div className="bridging__card-feature">
                <CheckIcon />
            ...
            <Link to="/login/company" className="bridging__card-link">
          ...
          <div className="bridging__card bridging__card--freelancer">
            ...
            <Link to="/login/freelancer" className="bridging__card-link">
              Learn More <ArrowIcon />
            </Link>
          </div>
        </div>
